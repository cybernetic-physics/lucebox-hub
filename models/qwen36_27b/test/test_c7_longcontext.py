...
def main():
    ...
    results = []
    # prefill_qwen3x_naive does S decode launches. At 27B BF16, each decode
    # is HBM-bound at ~180ms (50GB/273GB/s), so larger S blow up linearly.
    # Sweep only what completes within ~5 min per S until the parallel-S
    # prefill (S2) lands.
